...
#             if not linestr.lstrip()[1:].rstrip():
#                 spaceline += 1
#                 if parseStage < 4:
#                     print(str(i+1) + ': ' + 'wrong fromat6 : lack of line3 or line4')
#                 parseStage = 5
#                 if spaceline > 1:
#                     if debug: print(str(i+1) + ': ' + 'wrong fromat7 : more than one empty line after line 4')
#             if '@param' in linestr:
#                 parseStage = 6
#                 if spaceline == 0:
#                     print(str(i+1) + ': ' + 'wrong fromat8 : one empty line required after line 4')
